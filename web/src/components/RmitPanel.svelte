...
・弱体(Weak): 敵が Weak のとき与ダメは 0.75 倍。受けたダメ ÷ 3 を Weak applier 群へ stacks 加重で加算。
・筋力低下: 敵の筋力に対して各 applier が下げた量で個別に評価。合計筋力がプラスでも「自分が下げた分」は貢献として加算（例: 元 +5 の敵に A が −3 撒けば、合計 +2 でも A は 1 ヒットあたり 3 軽減）。`;
</script>
